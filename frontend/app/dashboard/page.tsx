            ...
            {step === 3 && (
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <label className="flex cursor-pointer items-start gap-2 rounded border border-sky-200 bg-sky-50 px-3 py-2">
                    <input
                      type="radio"
                      className="mt-1"
      ...
      {loading ? (
        ...
        <ul className="space-y-2">
          {wishlists.map((wl) => (
            <li
              key={wl.id}
              className="rounded border border-sky-100 bg-white px-3 py-2 text-sm flex items-center justify-between gap-3 shadow-sm"
            >
